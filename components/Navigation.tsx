        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <div className="mt-12 border-t border-gray-800 pt-8">
                 <p className="text-gray-500 text-sm uppercase tracking-widest mb-4">Contact</p>
                 <a href="mailto:lucasemmanuelramirez56@gmail.com" className="text-lg text-white break-all block mb-6">lucasemmanuelramirez56@gmail.com</a>
                 ...
                 <div className="flex gap-6 mt-6">
                   <a 
                     ...
                     className="flex items-center gap-2 text-gray-400 hover:text-[#C9FD74] transition-colors"
                   >
